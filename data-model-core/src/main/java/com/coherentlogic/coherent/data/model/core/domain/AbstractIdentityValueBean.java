...
/**
 * A partial implementation of a bean that has both an identity and a
 * type-specific value.
 *
 * We do not keep an instance of type T as a data member here because we need to
 * use XStream annotations to indicate what converter to use.
 *
